  ...
  // ── A1. Beni paesaggistici Art. 136 (bellezze individue e di insieme) ──
  {
    ...
    layers: [
      ...
      },
      {
        ...
        wfsUrl: "http://wms.pcn.minambiente.it/ogc?service=wfs",
        srid: "32632",
        opacity: 0.55,
    ...
    layers: [
      {
        ...
        arcgisLayers: "show:0",
        wmsUrl: "http://wms.pcn.minambiente.it/ogc?map=/ms_ogc/WMS_v1.3/Vettoriali/Vincoli_Paesaggistici_Art142.map",
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    layers: [
      ...
      },
      {
        ...
        wmsUrl: "http://wms.pcn.minambiente.it/ogc?service=wms&layer=strade",
        wfsUrl: "http://wms.pcn.minambiente.it/ogc?service=wfs",
        srid: "32632",
        opacity: 0.45,
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    layers: [
      ...
      },
      {
        ...
        wmsUrl: "http://wms.pcn.minambiente.it/ogc?service=wms&layer=aree_contaminate",
        wfsUrl: "http://wms.pcn.minambiente.it/ogc?service=wfs",
        srid: "32632",
        opacity: 0.45,
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    layers: [
      ...
      },
      {
        ...
        wmsUrl: "http://wms.pcn.minambiente.it/ogc?service=wms&layer=suoli",
        wfsUrl: "http://wms.pcn.minambiente.it/ogc?service=wfs",
        srid: "32632",
        opacity: 0.45,
    ...
    layers: [
      {
        ...
        description: "PAI pericolosità — Regione Basilicata. Inserire URL nei settings.",
      },
      {
        ...
        opacity: 0.5,
        bounds: [39.89, 15.33, 41.14, 16.87],
        description: "Vincolo idrogeologico — RSDI Basilicata. Inserire URL nei settings.",
      },
    ],
  },
    ...
    layers: [
      {
        ...
        description: "PAI pericolosità — Regione Calabria. Inserire URL nei settings.",
      },
    ],
  },
    ...
    layers: [
      {
        ...
        description: "Vincoli paesaggistici — Geoscopio Regione Toscana. Inserire URL nei settings.",
      },
      {
        ...
        opacity: 0.5,
        bounds: [42.24, 9.69, 44.47, 12.37],
        description: "Vincolo idrogeologico — Geoscopio Regione Toscana. Inserire URL nei settings.",
      },
      {
        ...
        opacity: 0.5,
        bounds: [42.24, 9.69, 44.47, 12.37],
        description: "Carta dell'uso del suolo — Regione Toscana. Inserire URL nei settings.",
      },
    ],
  },
    ...
    layers: [
      {
        ...
        description: "PAI pericolosità geomorfologica — Regione Sicilia. Inserire URL nei settings.",
      },
      {
